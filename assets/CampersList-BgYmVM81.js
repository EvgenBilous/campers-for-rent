import{f as Ze,u as v,g as M,r as U,h as et,i as tt,k as nt,N as ot,l as rt,b as je,m as at,j as s,s as T,O as st,a as it,n as lt,o as ct,p as ut,q as dt}from"./index-ChhiJsof.js";import{a as ft}from"./selectors-D219qwtO.js";const pt=t=>t.favorites.favoritesCampers,ht=t=>t.filter.location,vt=t=>t.filter.equipment,mt=t=>t.filter.type,ho=Ze([ft,ht,vt,mt],(t,e,n,r)=>{const i=e.toLowerCase().trim().split(",").map(u=>u.trim()),[f,y]=i;let a=t;return n&&(a=a.filter(u=>u.details&&(u.details[n]||u.details[n]===void 0))),r&&(a=a.filter(u=>u.form===r)),a.filter(u=>{const[g,c]=u.location.toLowerCase().split(", ");return(!f||c.includes(f))&&(!y||g.includes(y))})}),yt=v.li`
